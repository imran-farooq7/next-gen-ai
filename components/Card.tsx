...
export default function Card({ template }: Props) {
	return (
		<Link className="h-full" href={`/dashboard/templates/${template.slug}`}>
			<div className="dark:bg-black h-full overflow-hidden rounded-lg bg-white shadow hover:bg-gray-200 transition-all ease-in-out hover:cursor-pointer">
